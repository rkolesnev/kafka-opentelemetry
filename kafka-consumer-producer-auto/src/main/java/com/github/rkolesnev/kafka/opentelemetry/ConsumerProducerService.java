...
public class ConsumerProducerService {
  ...
  public static void main(String[] args) {
    running.set(true);
    Producer<String, String> producer = new KafkaProducer<>(getProducerPropsWithInterceptor());
    Consumer<String, String> consumer = new KafkaConsumer<>(getConsumerPropsWithInterceptor());
  ...
  private static Properties getConsumerPropsWithInterceptor() {
    Properties props = Common.getConsumerProperties();
    props.setProperty(ConsumerConfig.INTERCEPTOR_CLASSES_CONFIG,
        TracingConsumerInterceptor.class.getName());
    return props;
  }

  private static Properties getProducerPropsWithInterceptor() {
