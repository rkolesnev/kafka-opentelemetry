...
public class Streams extends BaseStreamsStatefulAgentTransforms {

    // java -javaagent:path/to/opentelemetry-javaagent.jar -Dotel.service.name=my-kafka-service -Dotel.traces.exporter=jaeger -Dotel.metrics.exporter=none -Dotel.instrumentation.messaging.experimental.receive-telemetry.enabled=false -jar target/kafka-streams-stateful-agent-mapper-1.0-SNAPSHOT-jar-with-dependencies.jar
