...
public class BaseConsumer {
    ...
    private static final String DEFAULT_TOPIC = Topics.TopicB;
    private static final String DEFAULT_CONSUMER_GROUP = "c-";
    ...
    public Properties loadKafkaConsumerProperties() {
        ...
        props.setProperty(CommonClientConfigs.GROUP_ID_CONFIG, this.consumerGroup + RandomUtils.nextInt(0,10));
