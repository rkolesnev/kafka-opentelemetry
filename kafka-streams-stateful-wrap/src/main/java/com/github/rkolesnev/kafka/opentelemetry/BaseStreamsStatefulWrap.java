...
public class BaseStreamsStatefulWrap {
  ...
  private static final String DEFAULT_APPLICATION_ID = "streams-no-agent";
  private static final String DEFAULT_VANILLA = "true";

  private static final Logger log = LogManager.getLogger(BaseStreamsStatefulWrap.class);
