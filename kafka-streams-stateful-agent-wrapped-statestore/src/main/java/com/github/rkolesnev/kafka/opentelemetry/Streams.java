...
public class Streams extends BaseStreamsStatefulAgentWrappedStateStore {

    // java -javaagent:path/to/opentelemetry-javaagent.jar -Dotel.service.name=my-kafka-service -Dotel.traces.exporter=jaeger -Dotel.metrics.exporter=none -Dotel.instrumentation.messaging.experimental.receive-telemetry.enabled=true -jar target/kafka-streams-stateful-agent-wrapped-statestore-1.0-SNAPSHOT-jar-with-dependencies.jar
